    ...
    return(
        ...
        <nav className="border border-primary border-5 border-top-0 border-bottom-0 border-end-0 navbar navbar-expand-lg navbar-dark bg-dark shadow sticky-top">
            <div className="container-fluid">
                <Link className="navbar-brand" to="/user">CGS</Link>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav ms-auto mb-md-0">
                        <li className="nav-item me-1" title="Home">
                            <Link className="nav-link" to="/user/home"> <i className="fa fa-home fa-2x"></i><span className="fs-5 ms-2 d-inline d-lg-none">Home</span></Link>
                        </li>
                        <li className="nav-item me-1" title="Get Certificate">
                            <Link className="nav-link" to="/user/get_certificate"> <i className="fa fa-award fa-2x"></i><span className="fs-5 ms-2 d-inline d-lg-none">Get Certificate</span></Link>
                        </li>
